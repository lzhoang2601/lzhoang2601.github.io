...
- May mắn đã có nhiều nhà phát triển làm thêm một số phần cứng được hoạt động.
- Với đa số trường hợp phiên bản macOS cao nhất có thể sử dụng đều dựa vào GPU hỗ trợ đến macOS nào.
::
...
- Các CPU thuộc thế hệ từ Sandy Bridge([2xxx](https://en.wikipedia.org/wiki/Sandy_Bridge#List_of_Sandy_Bridge_processors){target="_blank"}) cho tới mới nhất là Raptor Lake([13xxx](https://en.wikipedia.org/wiki/Raptor_Lake#List_of_13th_generation_Raptor_Lake_processors){target="_blank"}) đều được hỗ trợ cài đặt macOS.
    - Việc `FakeCPUID` là bắt buộc với các dòng CPU Celeron, Pentium cùng các thế hệ như: Haswell-E, Broadwell-E, Rocket Lake, Alder Lake, Raptor Lake.
...
| --------- | --------- | -------------------- | -------- |
| [Sandy Bridge](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&released=2011&igp=Yes&sort=name){target="_blank"} | HD 3000, HD 2000 | 10.6.7 --> 10.13 | HD 2000 không hoạt động chức năng xuất hình |
| [Ivy Bridge](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&released=2012&igp=Yes&sort=name){target="_blank"} | HD (P)4000, HD 2500 | 10.7 --> 11 | HD 2500 không hoạt động chức năng xuất hình |
| [Haswell](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&released=2013&igp=Yes&sort=name){target="_blank"} | HD 4200/4400/4600/5000/5100/P4600/P4700 | 10.8 --> 12 | Với HD 4400 cần fake id |
| [Broadwell](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&released=2014&igp=Yes&sort=name){target="_blank"} | HD 5300/5500/5600/6000/6100/6200/P5700 và Iris Pro P6300 | 10.10.2 --> 12 | |
| [Skylake](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&released=2015&igp=Yes&tdp=15%20W&sort=name){target="_blank"} | HD 515/520/(P)530, Iris 540/550, Iris Pro 580/P555/P580 | 10.11.4 --> 13 | HD 510 không được hỗ trợ <br> Cần dùng giá trị của **Kaby Lake** để hoạt động trên macOS Ventura | 
| Kaby Lake ([GT2](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&igp=Yes&gpu=Kaby%20Lake%20GT2&sort=name){target="_blank"}, [GT3e](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&igp=Yes&gpu=Kaby%20Lake%20GT3e&sort=name){target="_blank"}) | HD 615/620/630, UHD 620 và Iris Plus 640/650 | 10.12.6 --> 13 | HD 610 được sử dụng trên CPU Pentium nên không được hỗ trợ |
| [Whisky Lake](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&igp=Yes&gpu=Whiskey%20Lake%20GT2&sort=name){target="_blank"} | UHD 620 | 10.13.6 --> 14 | |
| [Amber Lake](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&released=2018&igp=Yes&gpu=Amber%20Lake%20GT2&sort=name){target="_blank"} | UHD 615 và UHD 617 | 10.13.6 --> 14 | |
| Coffee Lake ([GT2](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&igp=Yes&gpu=Coffee%20Lake%20GT2&sort=name){target="_blank"}, [GT3e](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&igp=Yes&gpu=Coffee%20Lake%20GT3e&sort=name){target="_blank"}) | UHD (P)630, Iris Plus 645/655 | 10.13.6 --> 14 | UHD 610 không được hỗ trợ |
| [Comet Lake](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&released=2020&igp=Yes&gpu=Comet%20Lake%20GT2&sort=name){target="_blank"} | UHD 630 và UHD P630 | 10.13.6 --> 14 | |
| Ice Lake ([GT1](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&gpu=Ice%20Lake%20GT1&sort=name){target="_blank"}, [GT2](https://www.techpowerup.com/gpu-specs/?mfgr=Intel&gpu=Ice%20Lake%20GT2&sort=name){target="_blank"}) | UHD Graphics G1, Iris Plus G7 và Iris Plus G4 | 10.15.4 --> 14 | |
::

### AMD

::list{type="danger"}
- [Navi 22](https://www.techpowerup.com/gpu-specs/amd-navi-22.g951){target="_blank"}, [Navi 24](https://www.techpowerup.com/gpu-specs/amd-navi-24.g965){target="_blank"}, [APU RDNA 2](https://en.wikipedia.org/wiki/RDNA_2#Integrated_graphics_processors_(iGPs)){target="_blank"}, [RDNA 3](https://en.wikipedia.org/wiki/RDNA_3){target="_blank"} cùng các AMD APU (GCN < 5) hiện không hỗ trợ bất kì macOS nào.
::

::list{type="warning"}
- Dòng [Lexa](https://www.techpowerup.com/gpu-specs/amd-lexa.g806){target="_blank"} cần `fake-id` để hoạt động, sẽ gặp lỗi ở chỗ nãy chỗ kia.
::
...
| --------- | --------- | -------------------- | -------- |
| [Raven](https://www.techpowerup.com/gpu-specs/amd-raven.g816){target="_blank"} | CPU Ryzen/Athlon có APU thuộc thế hệ Raven Ridge(2xxx), Picasso(3xxx) | 10.15 --> 14 | Chưa hoạt động đầy đủ, xem chi tiết các vấn đề tại bảng bên dưới |
| [Renoir](https://www.techpowerup.com/gpu-specs/amd-renoir.g1058){target="_blank"} | CPU Ryzen/Athlon có APU thuộc thế hệ Renoir(4xxx), Cezanne(5xxx), Barcelo(5xxx) và Barcelo-R(7x30) | 10.15 --> 14 | Chưa hoạt động đầy đủ, xem chi tiết các vấn đề tại bảng bên dưới |
| [Navi 23](https://www.techpowerup.com/gpu-specs/amd-navi-23.g926){target="_blank"} | RX 6600, RX 6600 XT và RX 6650 XT | 12.1 --> 14 | Cần sử dụng bootarg **agdpmod=pikera** <br> Cần fake ID với RX 6650 XT |
| [Navi 21](https://www.techpowerup.com/gpu-specs/amd-navi-21.g923){target="_blank"} | RX 6800, RX 6800 XT, RX 6900 XT và RX 6950 XT | 11.4 --> 14 | Cần sử dụng bootarg **agdpmod=pikera** <br> Cần fake ID với RX 6900 XT (XTXH) và RX 6950 XT |
| [Navi 10](https://www.techpowerup.com/gpu-specs/amd-navi-10.g861){target="_blank"} | Các GPU thuộc RX 5XXX và Radeon Pro W5XXX | 10.15.1 --> 14 | Cần sử dụng bootarg **agdpmod=pikera** <br> Cần thêm property `ATY,Rom#` cho GPU MSI Navi để tránh lỗi do VBIOS làm hỏng bộ cài đặt <br> Tìm hiểu thêm tại [Installer not working with 5700XT #901](https://github.com/acidanthera/bugtracker/issues/901){target="_blank"} |
| [Vega 20](https://www.techpowerup.com/gpu-specs/amd-vega-20.g848){target="_blank"} | Radeon VII | 10.14.5 --> 14 | |
| [Vega 10](https://www.techpowerup.com/gpu-specs/amd-vega-10.g800){target="_blank"} | Các GPU sử dụng chip **Vega 10 XL**, **Vega 10 XT** và **Vega 10 XTX** | 10.13 --> 14 | Cần tránh sử dụng GPU đến từ hãng **XFX** do vấn đề về VBIOS |
| [Polaris](https://www.techpowerup.com/gpu-specs/?mobile=No&generation=Polaris&eol=Active&sort=name){target="_blank"}, [Ellesmere](https://www.techpowerup.com/gpu-specs/?mobile=No&gpu=Ellesmere&eol=Active&sort=name){target="_blank"}, [Baffin](https://www.techpowerup.com/gpu-specs/?mobile=No&gpu=Baffin&eol=Active&sort=name){target="_blank"} | RX4XX, RX5XX, Radeon Pro WX 7100/5100/4100 và E9550 | 10.12 --> 14 | Cần flash VBIOS của **RX570** nếu sử dụng **Radeon RX 580 2048SP** |
| R9, R7 | R9 Fury (X), R9 Nano, R9 390(X), R9 380(X), R9 370X, R9 360, R9 290(X), R9 280(X), R9 270X, R9 255, R9 260, R9 255 <br> R7 370, R7 360X, R7 270, R7 265, R7 260X, R7 250(X), R7 240 | 10.10 --> 12 | Với R7 250(X) cần sử dụng bootarg **radpg=15** <br> Với R9 290X, R7 370,... cần sử dụng bootarg **-raddvi** nếu gặp lỗi về DVI transmitter <br> Cần fake ID với hầu hết GPU có mặt |
| HD 8000 | HD 8740, HD 8760, HD 8770, HD 8850, HD 8870, HD 8890, HD 8950, HD 8970 | 10.8 --> 12 | |
| HD 7000 | Dual AMD FirePro D300/D500/D700, FirePro W5100/W7000/W9000, HD 77x0/78x0(XT)/79x0 | 10.8 --> 12 | Với HD 7730/7750/7770 cần sử dụng bootarg **radpg=15** <br> Cần fake ID với FirePro W5100 |
::
...
#content
- Lỗi eDP link training trên một số laptop khiến lỗi black screen sau khi kết thúc verbose.
...
- Với Qualcomm chỉ dùng được wi-fi và bluetooth, Intel hoạt động thêm Handoff cùng Universal Clipboard và chỉ một số mẫu Broadcom hoạt động đầy đủ cả Airdrop
