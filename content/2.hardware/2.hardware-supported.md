...
| --------- | --------- | -------------------- | -------- |
| [Raven](https://www.techpowerup.com/gpu-specs/amd-raven.g816){target="_blank"} | CPU Ryzen/Athlon có APU thuộc thế hệ Raven Ridge(2xxx), Picasso(3xxx) | 11 --> 14 | Chưa hoạt động đầy đủ, xem chi tiết các vấn đề tại bảng bên dưới |
| [Renoir](https://www.techpowerup.com/gpu-specs/amd-renoir.g1058){target="_blank"} | CPU Ryzen/Athlon có APU thuộc thế hệ Renoir(4xxx), Cezanne(5xxx), Barcelo(5xxx) và Barcelo-R(7x30) | 11 --> 14 | Chưa hoạt động đầy đủ, xem chi tiết các vấn đề tại bảng bên dưới |
| [Navi 23](https://www.techpowerup.com/gpu-specs/amd-navi-23.g926){target="_blank"} | RX6600 và RX6600 XT | 12.1 --> 14 | Cần sử dụng bootarg **agdpmod=pikera** |
| [Navi 21](https://www.techpowerup.com/gpu-specs/amd-navi-21.g923){target="_blank"} | RX 6800, RX 6800 XT, RX 6900 XT | 11.4 --> 14 | Cần sử dụng bootarg **agdpmod=pikera** <br> Với RX6900 XT XTXH có ID `0x73AF` cần fake id thành `0x73BF` |
...
| [Polaris](https://www.techpowerup.com/gpu-specs/?mobile=No&generation=Polaris&eol=Active&sort=name){target="_blank"}, [Ellesmere](https://www.techpowerup.com/gpu-specs/?mobile=No&gpu=Ellesmere&eol=Active&sort=name){target="_blank"}, [Baffin](https://www.techpowerup.com/gpu-specs/?mobile=No&gpu=Baffin&eol=Active&sort=name){target="_blank"} | RX4XX, RX5XX, Radeon Pro WX 7100/5100/4100 và E9550 | 10.12 --> | Cần flash VBIOS của `RX570` nếu sử dụng `Radeon RX 580 2048SP` |
| R9, R7 | R9 Fury (X), R9 Nano, R9 390(X), R9 380(X), R9 370X, R9 360, R9 290(X), R9 280(X), R9 270X, R9 255, R9 260, R9 255 <br> R7 370, R7 360X, R7 270, R7 265, R7 260X, R7 250(X), R7 240 | 10.10 --> 12 | Hầu hết cần fake id để hoạt động <br> Với R7 250(X) cần sử dụng bootarg **radpg=15** <br> Sử dụng bootarg **-raddvi** nếu gặp lỗi về DVI cho 290X, 370,... |
| HD 8000 | HD 8740, HD 8760, HD 8770, HD 8850, HD 8870, HD 8890, HD 8950, HD 8970 | 10.8 --> 12 | |
| HD 7000 | Dual AMD FirePro D300/D500/D700, FirePro W5100 (cần fake id)/W7000/W9000, HD 77x0/78x0(XT)/79x0 | 10.8 --> 12 | Với HD 7730/7750/7770 cần sử dụng bootarg **radpg=15** |
::
